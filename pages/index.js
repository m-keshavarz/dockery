...
const Pricing = () => {
  return (
    <Div
      className="bg-[#f0f1f4] pb-28 lg:pb-72 flex-col lg:flex lg:flex-row lg:justify-between"
      id="plans"
    >
...
const PlansMobile = () => {
  return (
    <Div
      className="relative pb-16 bg-plans bg-no-repeat bg-cover bg-center z-10 after:absolute after:top-0 after:left-0 after:bg-white after:opacity-[89%] after:w-full after:h-full"
      id="services"
    >
...
const PlansDesktop = () => {
  return (
    <Div
      className="relative py-32 px-16 bg-plans bg-no-repeat bg-cover bg-center z-10 after:absolute after:top-0 after:left-0 after:bg-white after:opacity-[89%] after:w-full after:h-full"
      id="services"
    >
